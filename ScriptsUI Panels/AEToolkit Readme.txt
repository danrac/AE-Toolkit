...
2.2.9 repairs Sourcing > Import Assets: it accepts normal paths, file URLs, quoted paths, and folder-plus-filename lists, then reports any unresolved files after importing valid ones.
