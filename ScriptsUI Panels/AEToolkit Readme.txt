...
2.2.12 repairs the Import Assets button so pasted paths reach the importer reliably. Sourcing > Import Assets accepts normal paths, file URLs, quoted paths, and folder-plus-filename lists, then reports any unresolved files after importing valid ones.
