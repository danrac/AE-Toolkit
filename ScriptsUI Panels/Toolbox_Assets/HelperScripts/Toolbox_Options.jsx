...
var pal = (thisObj instanceof Panel) ? thisObj : new Window("dialog", "Build Options", undefined, { resizeable: false });
        ...
        if (pal != null) {
            ...
            "group { orientation:'column', alignment:['center','top'], \
                ...
                cmds10: Group {orientation:'row', alignment:['fill','bottom'], \
                    title: StaticText { text:'" + "TEXTURE RESOURCES:" + "', alignment:['left','center']} , \
                    texturesField: EditText { alignment:['right','center'], preferredSize:[175,20], properties:{multiline:false} }, \
                }, \
                title: StaticText { text:'" + "------------------------------------------------------------------------------------------" + "'} , \
    ...
    function SavePrefs(){
        ...
        var textureRec = this.parent.parent.cmds10.texturesField.text;
