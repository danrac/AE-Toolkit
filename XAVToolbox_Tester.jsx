(function XAVToolbox_Tester(thisObj) {
    ...
    XAVToolboxData.scriptName = "XAVToolbox_Tester";
    ...
    function XAVToolbox_Tester_buildUI(thisObj) {
        var pal = (thisObj instanceof Panel) ? thisObj : new Window("palette", "XAVToolbox_Tester", undefined, { resizeable: true });
        if (pal != null) {
            var resSourcing =
...
function saveUserPrefs(userName, userPrefInput) {
    var filePath = scriptPath + "/XAVToolbox_Assets/UserPrefs/";
...
////CREATE / MODIFY///////////
    ...
    function pasteFilePaths(){
        ...
        var clipboardScriptPath = new File(scriptPath + "/XAVToolbox_Assets/XAVToolbox_GetClipboard.command").execute();
...
////CHECKERS FUNCTIONS////////
    ...
    function itemCheck(newchartname){
        ...
        if(itemMatchArr <= 0){
            ...
            var chartFile = scriptPath + "/XAVToolbox_Assets/" + newchartname;
    ...
    function matteCheck(newmattename){
        ...
        if(itemMatchArr.length <= 0){
            var imagesFolder = getFolderByName("Images");
            var matteFile = scriptPath + "/XAVToolbox_Assets/" + newmattename;
...
////COVER FUNCTIONS////////
    ...
    function MakeCover(){
        ...
        var filePath = scriptPath + "/XAVToolbox_Assets/" + CPname;
...
////SHOW EXTRAS MENU///////////////
    ...
    function extras(){
            $.evalFile(scriptPath + "/XAVToolbox_Assets/XAVToolbox_Extras.jsx");
    }
...
////BUILD OPTIONS///////////////
    ...
    function callBuildOptionUI(){
        $.evalFile(scriptPath + "/XAVToolbox_Assets/XAVToolbox_Options.jsx");
    }
...
////BUILD UI FUNCTION///////
    ...
    var rdetPal = XAVToolbox_Tester_buildUI(thisObj);
    if (rdetPal !== null) {
